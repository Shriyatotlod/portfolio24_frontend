...
export const userReducer = createReducer(initialState, (builder) => {
  builder
    .addCase(createAction("GET_USER_REQUEST"), (state) => {
      state.loading = true;
    })
    .addCase(createAction("GET_USER_SUCCESS"), (state, action) => {
      state.loading = false;
      state.isAuthenticated = true;
      state.user = action.payload;
    })
    .addCase(createAction("GET_USER_FAILURE"), (state, action) => {
      state.loading = false;
      state.error = action.payload;
    })
    .addCase(createAction("CLEAR_ERRORS"), (state) => {
      state.error = null;
    });
});
